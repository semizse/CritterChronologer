...
public class ScheduleController {
    ...
    public ScheduleDTO createSchedule(@RequestBody ScheduleDTO scheduleDTO) {
        ...
        return Utils.convertToScheduleDTO(scheduleService.save(schedule, scheduleDTO.getEmployeeIds(), scheduleDTO.getPetIds()));
    }

    @GetMapping
    public List<ScheduleDTO> getAllSchedules() {
        List<Schedule> schedules = scheduleService.findAll();
        return schedules.stream().map(Utils::convertToScheduleDTO).collect(Collectors.toList());
    }
